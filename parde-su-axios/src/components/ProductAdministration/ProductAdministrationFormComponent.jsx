        ...
        <div>
            <form className='container my-5' onSubmit={handleSubmit}>
                <div className='form-group'>
                    ...
                    <input onChange={handleChange} type='text' className='form-control' id='productTitle' name='title' value={title} />
                </div>
                <div className='form-group'>
                ...
                <div className='row'>
                    ...
                    <div className='form-group col-6'>
                        ...
                        <input onChange={handleChange} type='text' className='form-control' id='productQuantity' name='quantity' value={quantity} />
                    </div>
                </div>
