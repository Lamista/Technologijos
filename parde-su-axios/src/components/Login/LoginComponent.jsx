    ...
    if (currentUser === undefined) {
        ...
        return (
            <form className='navbar-form form-inline' onSubmit={handleLogin}  >
                ...
                <button className='btn btn-primary mt-2 mt-lg-0' type='submit'>Login</button>
            </form>
        )
    } else {
        console.log('defined');
        return (
            <div className='form-inline' >
                ...
                <button className='btn btn-primary mt-2 mt-lg-0' onClick={handleLogout}>Logout</button>
            </div>
        )
    }
}
